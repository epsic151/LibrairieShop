...
////////////////////////////////// ---------- Entête du programme ---------- //////////////////////////////////
	...
	#################################################################
	#
	#	View (form) of new book, used to add a new book!
	#
	#################################################################
...
<div class="container">
  	<div class="row">
		<form method="POST" class="form-vertical" id="new_book" enctype="multipart/form-data">
			<div class="col-md-6">
			...
			<div class="col-md-12">
				...
				<div class="form-group text-center">
					...
					<span class="text-success"><?php if (isset($return_s)) {echo $return_s; $dis = 'disabled';} ?></span><hr>
					<button type="submit" name="submit" <?php echo $dis; ?> value="Enregistrer" class="btn btn-primary">Enregistrer</button>
				</div>
			</div>
		</form>
	</div>
